import type { RenderExtensionTarget, PaymentOption } from '@shopify/ui-extensions/checkout';
/**
 ...
 */
export declare function useSelectedPaymentOptions<Target extends RenderExtensionTarget = RenderExtensionTarget>(): PaymentOption[];
