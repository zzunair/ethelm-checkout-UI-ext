...
export interface FlowContext<Resources extends ShopifyRestResources = ShopifyRestResources> {
    /**
...
export type AuthenticateFlow<Resources extends ShopifyRestResources = ShopifyRestResources> = (request: Request) => Promise<FlowContext<Resources>>;
