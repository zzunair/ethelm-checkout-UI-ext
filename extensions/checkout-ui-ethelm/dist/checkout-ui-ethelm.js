(() => {
  ...
  // extensions/checkout-ui-ethelm/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const { extension: extension2 } = useExtensionApi();
    ...
    (0, import_react12.useEffect)(() => {
      function manageStorage() {
        return __async(this, null, function* () {
          try {
            yield write("outOfStockProduct", true);
            const localValue = yield read("outOfStockProduct");
            if (localValue) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { title: "checkout-ui-ethelm", children: translate("welcome", { target: extension2.target }) }) });
  }
})();
//# sourceMappingURL=checkout-ui-ethelm.js.map
